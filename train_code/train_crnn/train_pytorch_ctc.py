...
config.manualSeed = random.randint(1, 300)  # fix seed
...
#         {'params':crnn.rnn[1].embedding.parameters(), 'lr':config.lr, 'betas':(0.5,0.999)},
#         {'params':rest_params, 'lr':config.lr, 'betas':(0.5,0.999)}
#     ])
